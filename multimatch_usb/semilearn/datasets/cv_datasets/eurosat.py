...
def get_eurosat(args, alg, dataset, num_labels, num_classes, data_dir='./data', include_lb_to_ulb=True):
    ...
    train_unlabeled_dataset = EuroSat(alg, data_dir, split="trainval", is_ulb=True, idx_list=train_unlabeled_idxs, transform=transform_weak, transform_strong=transform_strong,transform_stronger=transform_stronger)
...
class EuroSat(ImageFolder, BasicDataset):
    ...
    def __init__(self, alg, root, split, is_ulb=False, idx_list=None, transform=None, target_transform=None, transform_strong=None, transform_stronger=None):
        ...
        self.stronger_transform = transform_stronger
