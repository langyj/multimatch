...
mean['rsscn'] = [0.485, 0.456, 0.406]
mean['cifar10'] = [0.485, 0.456, 0.406]
mean['nwpu'] = [0.485, 0.456, 0.406]
mean['cifar100'] = [x / 255 for x in [129.3, 124.1, 112.4]]

std['ucmd'] = [0.229, 0.224, 0.225]
std['rsscn'] = [0.229, 0.224, 0.225]
std['cifar10'] = [0.229, 0.224, 0.225]
std['nwpu'] = [0.229, 0.224, 0.225]
std['cifar100'] = [x / 255 for x in [68.2, 65.4, 70.4]]


def get_rsscn(args, alg, name, num_labels, num_classes, data_dir='./data', include_lb_to_ulb=True):
    ...
    i = 0
    for folder in folders:
        test_targets.append(int(folder[:-8]))
        img = Image.open(file + '/' + folder)
        img = np.array(img)
        test_data[i] = img
        i += 1
