...
from semilearn.core.criterions import CELoss, ConsistencyLoss, MetricLoss, RankingLoss
...
class AlgorithmBase:
    ...
    def __init__(self, args, net_builder, tb_log=None, logger=None, **kwargs):
        ...
        self.epochs = args.epoch  # epoch次数
        self.num_train_iter = args.num_train_iter  # 总的迭代次数
        self.num_eval_iter = args.num_eval_iter
        self.num_log_iter = args.num_log_iter
        self.num_iter_per_epoch = int(self.num_train_iter // self.epochs)  # 每个epoch需要的迭代次数
        ...
        self.N = args.N
        self.margin_embedding = args.margin_embedding
        ...
        self.ranking_loss = RankingLoss(embedding_size=self.embedding_size, N=self.N, lambda_1=self.lambda_1,
                                        lambda_2=self.lambda_2, margin_embedding=self.margin_embedding).cuda(args.gpu)
