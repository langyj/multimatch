...
def get_config():
    ...
    parser.add_argument("--margin_embedding", type=float, default=0.5)
    parser.add_argument("--lambda_1", type=float, default=1.)
    parser.add_argument("--lambda_2", type=float, default=1.)
    parser.add_argument("--strong_n", type=float, default=3)
    parser.add_argument("--stronger_n", type=float, default=4)
